						...
						<div class="modal_table">
							<div class="wi_board_form_row">
								...
								<div class="wi_board_form_content">
                  					<input type="text" id="product_code" class="wi_board_input_control" autocomplete="off">
								</div>
							</div>
							...
							<div class="wi_board_form_row">
								...
								<div class="wi_board_form_content">
									<input type="text" id="product_position" class="wi_board_input_control" autocomplete="off">
								</div>
							</div>
							<div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">대분류</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_b_class" class="wi_board_input_control" autocomplete="off">
							  </div>
							</div>
             				<div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">소분류</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_s_class" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							<div class="wi_board_form_row">
							...
							<div class="wi_board_form_row">
								...
								<div class="wi_board_form_content">
									<input type="text" id="product_stand" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							  <div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">제조사</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_maker" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							  <div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">거래처</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_custom" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							  <div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">단위</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_union" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							  <div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">단가</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_price" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							  <div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">수량</label></div>
								<div class="wi_board_form_content">
									<input type="text" id="product_amount" class="wi_board_input_control" autocomplete="off">
								</div>
						  	</div>
							<div class="wi_board_form_row">
							...
							<div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">도입일자</label></div>
								<div class="wi_board_form_content">
								<input type="text" id="product_in_date" class="wi_board_input_control" autocomplete="off">
							</div>
						  	</div>
							  <div class="wi_board_form_row">
								<div class="wi_board_form_title"><label for="" class="wi_board_label_control">이미지</label></div>
								<div class="wi_board_form_content">
								<input type="text" id="product_image" class="wi_board_input_control" autocomplete="off">
							</div>
						  	</div>
					</div>
				</section>
