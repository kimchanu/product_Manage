...
<head>
	...
	<!-- <link rel="stylesheet" href="GUGASMS/page/admin/css/yearpicker.css"> -->
	...
	<!-- <script src="GUGASMS/page/admin/js/yearpicker.js"></script> -->
	...
	<script src="GUGASMS/page/admin/js/state_month.js<?php echo $this->version; ?>"></script>
	...
	<style type="text/css">  
		...
		div#ui-datepicker-div {  
			margin-top: 41px;  
			/*adjust this value depend on input field height*/  
		}  
	</style> 
</head>
<body>
						...
						<section class="adm_section_container">
							...
							<div class="adm_section_container_body p-1">
                                <ul class="clearfix row input-list-container">
                                    ...
                                    <li class="col-md-6 mt-1">
										<p class="input-tit">조회기간</p>
                                        <div class="insert"><input placeholder="yyyy" type="text" id="year_date" readonly></div>
                                    </li>
                                </ul>
