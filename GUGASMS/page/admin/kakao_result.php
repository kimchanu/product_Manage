						...
						<section class="adm_section_container">
							...
							<div class="adm_section_container_body p-1">
                                ...
                                <div class="btn-list-con align-right mt-1 border-t">
                                    ...
                                    <p class="mt-1"><button type="button" class="btn-sm btn-primary" onclick="search_msg(1);">검색</button></p>
                                </div>
                            </div>
	...
	<div style="display:none;">
		<table>
			<tr data-copy="notice_copy">
				<td class="etc" data-attr="elem_num"></td>
				<td class="number" data-attr="send_time">2020-02-01</td>
				<td class="number" data-attr="callback">010-2224-1123</td>
				<td class="etc" data-attr="msg_type">SMS</td>
				<td class="number" data-attr="dstaddr">010-2225-3333</td>
				<td class="etc" data-attr="send_type">발송</td>
				<td class="tit" data-attr="text"></td>
				<td class="etc" data-attr="result"></td>
				<td class="etc" data-attr="telecom">SKT</td>
			</tr>
			<!-- <tr data-copy = "notice_copy">
				<td class="check">
