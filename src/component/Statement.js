...
const Statement = () => {
    ...
    return (
        <div className="p-4 mx-20">
            ...
            {/* 결재란 */}
            <div className="px-4" style={{ width: '65%', margin: '0 auto 3rem auto' }}>
            ...
            {/* 문서 정보 */}
            <table className="table-fixed border border-black text-sm text-center" style={{ width: '65%', margin: '2rem auto 2rem auto' }}>
                <tbody>
                    <tr>
            ...
            {/* 자재수불명세서 표 */}
            <table className="border border-black text-sm text-center table-fixed" style={{ width: '65%', margin: '0 auto' }}>
                <thead>
            ...
            <table className="border border-black text-sm text-center table-fixed mb-20" style={{ width: '65%', margin: '0 auto 5rem auto' }}>
                <thead>
                    <tr className="bg-gray-100">
                        <th className="border border-black" colSpan={3}>구 분</th>
